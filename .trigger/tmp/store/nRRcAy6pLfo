...
var runAuditTask = task({
  ...
  run: /* @__PURE__ */ __name(async (payload) => {
    const { prisma } = await import("../../prisma-UFIVEJ5G.mjs");
    const { completeAuditScan } = await import("../../complete-audit-scan-U5UPIEZB.mjs");
    const { failAuditScan } = await import("../../fail-audit-scan-37JOIXUS.mjs");
