...
var runAuditTask = task({
  ...
  run: /* @__PURE__ */ __name(async (payload) => {
    const { prisma } = await import("../../prisma-V7T3IL4I.mjs");
    const { completeAuditScan } = await import("../../complete-audit-scan-HZCQFMNV.mjs");
    const { failAuditScan } = await import("../../fail-audit-scan-LEP6LKER.mjs");
