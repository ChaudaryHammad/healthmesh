...
export const config = {
  matcher: [
    ...
    {
      source:
        "/((?!api|_next/static|_next/image|favicon.ico|sitemap.xml|robots.txt|sw.js|site.webmanifest|offline.html|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|txt|xml|webmanifest|js)$).*)",
      missing: [
