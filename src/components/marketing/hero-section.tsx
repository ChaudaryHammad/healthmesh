    ...
    <section className="relative w-full max-w-[88rem] mx-auto px-6 pt-24 pb-20 md:pt-32 md:pb-32 flex flex-col items-center">
      ...
      >
        ...
        <div className="flex flex-col space-y-6 lg:pr-8">
          ...
          >
            The all-in-one dashboard for Lighthouse performance, axe-core accessibility, SEO checks, and coverage scans. Starter includes manual scans; Pro and Agency add automated scheduling.
          </motion.p>
